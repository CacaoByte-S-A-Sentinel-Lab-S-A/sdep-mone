export const FormsGames = [
    ...
    {
      "checked": true,
      "description": "Acepto los terminos y condiciones correspondientes a los datos solicitados y toma en cuenta los metodos de pagos disponibles para la compra.",
      "disabled": false,
